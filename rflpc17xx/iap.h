 ...
 * @param [in] sector a sector identifier
 * @return the start address of the sector
 */
extern void *rflpc_iap_get_address_from_sector(int sector);
 ...
 * @param [in] length length of the buffer (<= 4k).
 * @return 0 if successful, -1 otherwise
 */
 ...
 * @param [in] length length of the destination <= 32k.
